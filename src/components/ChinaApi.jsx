...
const ChinaApi = () => {
    ...
    const fetchNews = async () =>{
        let response = await fetch("https://newsapi.org/v2/top-headlines?country=cn&apiKey=d773becdd3f547a182344b8549aef36a");
    ...
    if(flag){
        return (
            <>
            <div className="container text-primary" style={{marginBottom:"-150px",marginTop: "75px"}}>
            <div className='row'>
                {
                    news.map((element)=>{
                        return (
